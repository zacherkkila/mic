...
var mic = function mic(options) {
    ...
    that.start = function start() {
          if(audioProcess === null) {
            if(isWindows){
                var options = ['-b', bitwidth, '--endian', endian,
                ...
                audioProcess = spawn('sox', options, audioProcessOptions)
            }
            else if(isMac){
                var options = ['-b', bitwidth, '--endian', endian,
                             '-c', channels, '-r', rate, '-e', encoding,
                ...
                audioProcess = spawn('rec', options, audioProcessOptions)
            }
            else {
